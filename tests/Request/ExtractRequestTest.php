...
#[Group('UnitTests')]
#[Group('RequestTests')]
final class ExtractRequestTest extends TestCase
{
    ...
    public function testConstructor(
        ...
        $request = new ExtractRequest($path, $firstPage, $lastPage, $outputType, $resolution);
