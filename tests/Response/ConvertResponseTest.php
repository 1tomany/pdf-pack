...
#[Group('TransferTests')]
#[Group('ResponseTests')]
final class ConvertResponseTest extends TestCase
{
    public function testToString(): void
    {
        $this->assertEquals('Hello, world!', new ConvertResponse(OutputType::Text, 'Hello, world!')->__toString());
    }
    ...
    {
        $this->assertEquals($name, new ConvertResponse($type, '', $page)->getName());
    }
    ...
    public function testToDataUri(): void
    {
        ...
        $this->assertEquals($dataUri, new ConvertResponse(OutputType::Jpeg, $data)->toDataUri());
    }
}
