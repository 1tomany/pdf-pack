...
final class PopplerClientTest extends TestCase
{
    ...
    {
        $request = new ConvertRequest(__DIR__.'/../../../data/files/pages-1.pdf')->asJpegOutput();
    ...
    {
        $request = new ConvertRequest(__DIR__.'/../../../data/files/pages-1.pdf')->asTextOutput();
    ...
    {
        $request = new ConvertRequest(__DIR__.'/../../../data/files/pages-1.pdf')->fromPage(2)->toPage(2);
    ...
    {
        $provider = [
            [__DIR__.'/../../../data/files/pages-1.pdf', 1, 1, 1],
            [__DIR__.'/../../../data/files/pages-1.pdf', 1, null, 1],
            [__DIR__.'/../../../data/files/pages-2.pdf', 1, 1, 1],
            [__DIR__.'/../../../data/files/pages-2.pdf', 1, 2, 2],
            [__DIR__.'/../../../data/files/pages-2.pdf', 1, null, 2],
            [__DIR__.'/../../../data/files/pages-2.pdf', 2, 2, 1],
            [__DIR__.'/../../../data/files/pages-2.pdf', 2, null, 1],
            [__DIR__.'/../../../data/files/pages-3.pdf', 1, 1, 1],
            [__DIR__.'/../../../data/files/pages-3.pdf', 1, 2, 2],
            [__DIR__.'/../../../data/files/pages-3.pdf', 1, 3, 3],
            [__DIR__.'/../../../data/files/pages-3.pdf', 1, null, 3],
            [__DIR__.'/../../../data/files/pages-3.pdf', 2, 2, 1],
            [__DIR__.'/../../../data/files/pages-3.pdf', 2, 3, 2],
            [__DIR__.'/../../../data/files/pages-3.pdf', 2, null, 2],
            [__DIR__.'/../../../data/files/pages-3.pdf', 3, 3, 1],
            [__DIR__.'/../../../data/files/pages-3.pdf', 3, null, 1],
            [__DIR__.'/../../../data/files/pages-4.pdf', 1, 1, 1],
            [__DIR__.'/../../../data/files/pages-4.pdf', 1, 2, 2],
            [__DIR__.'/../../../data/files/pages-4.pdf', 1, 3, 3],
            [__DIR__.'/../../../data/files/pages-4.pdf', 1, 4, 4],
            [__DIR__.'/../../../data/files/pages-4.pdf', 1, null, 4],
            [__DIR__.'/../../../data/files/pages-4.pdf', 2, 2, 1],
            [__DIR__.'/../../../data/files/pages-4.pdf', 2, 3, 2],
            [__DIR__.'/../../../data/files/pages-4.pdf', 2, 4, 3],
            [__DIR__.'/../../../data/files/pages-4.pdf', 2, null, 3],
            [__DIR__.'/../../../data/files/pages-4.pdf', 3, 3, 1],
            [__DIR__.'/../../../data/files/pages-4.pdf', 3, 4, 2],
            [__DIR__.'/../../../data/files/pages-4.pdf', 3, null, 2],
            [__DIR__.'/../../../data/files/pages-4.pdf', 4, 4, 1],
    ...
    public static function providerPathFirstPageLastPageOutputTypeResolutionAndHash(): array
    {
        $provider = [
            ...
            [__DIR__.'/../../../data/files/pages-1.pdf', 1, OutputType::Jpeg, 72, '1186d43f1e28e87ae6d380978ed1d5e5eacb19a67d8e478a1d610e9c24d06238'],
            [__DIR__.'/../../../data/files/pages-1.pdf', 1, OutputType::Jpeg, 150, '1cb6e6f67bcffc8e16861c4789b67e06d4a59465933b98317183cff624a76df9'],
            [__DIR__.'/../../../data/files/pages-1.pdf', 1, OutputType::Jpeg, 300, '7bf4599051ab17eca303d6264739916b8a6a51231c11d6041bd81bbe41661373'],
            [__DIR__.'/../../../data/files/pages-1.pdf', 1, OutputType::Png, 48, 'afc38b7871f520934182b3ebf17f7bc3ef12ea0c87cb65416d3b540edf385083'],
            [__DIR__.'/../../../data/files/pages-1.pdf', 1, OutputType::Png, 300, 'beba09056cf8eb7f1359bc8fc1b486c35e0bffa40b216524fe61ffd176658c0b'],
            [__DIR__.'/../../../data/files/pages-2.pdf', 2, OutputType::Jpeg, 72, 'e1c2a91afd9508022090e1a4e836a63e48119aed48dd7bcf9e9cd1a857aaa90f'],
            [__DIR__.'/../../../data/files/pages-3.pdf', 3, OutputType::Jpeg, 72, '2ce164dc8d4b55df22b2faa94c88bea5caa4c5c6fd8998eb0d985aa1c51659a1'],
